...
#transition
t_4625_2 = PetriNet.Transition("4625_2", "4625_2")
repeat_pn.transitions.add(t_4625_2)

#places
source_0 = get_place_by_id(repeat_pn, "source0")

#updating
petri_utils.add_arc_from_to(source_0, t_4625_2, repeat_pn)
petri_utils.add_arc_from_to(t_4625_2, source_0, repeat_pn)
