...
composite_pn.transitions.update({t_4656, t_4657, t_4658, t_4663, tau_11, tau_12})
...
composite_pn.places.update({p19, p20, p21})
...
petri_utils.add_arc_from_to(p19, tau_11, composite_pn)
petri_utils.add_arc_from_to(t_4663, p20, composite_pn)
petri_utils.add_arc_from_to(tau_11, p20, composite_pn)
petri_utils.add_arc_from_to(p20, tau_12, composite_pn)
petri_utils.add_arc_from_to(p20, t_4657, composite_pn)
petri_utils.add_arc_from_to(tau_12, p21, composite_pn)
