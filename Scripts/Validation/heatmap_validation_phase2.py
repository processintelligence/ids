...
plot_dfg_heatmap(log_normalize_VM, title="Log Normalized VM", color_scheme="3-band")
plot_dfg_heatmap(row_normalize_VM, title="Row Normalized VM", color_scheme="3-band")

plot_dfg_heatmap(log_normalize_S, title="Log Normalized Phase 2", color_scheme="3-band")
plot_dfg_heatmap(row_normalize_S, title="Row Normalized Phase 2", color_scheme="3-band")


plot_dfg_heatmap(diff_row, title="Difference between VM and Phase 2", color_scheme="3-band", black_list=black, white_list=white)
