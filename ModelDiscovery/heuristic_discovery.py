...
if __name__ == "__main__":
    ...
    net, im, fm = pm4py.discover_petri_net_heuristics(log, dependency_threshold=DEPENDENCY_THRESHOLD, and_threshold=AND_THRESHOLD, loop_two_threshold=LOOP_TWO_THRESHOLD,)
